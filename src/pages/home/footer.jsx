    ...
    <footer className="footer-container">
      <div className="footer-link-container">
        <div className="footer-link-container-img">
          <img src="./img/mk logo tp.png" alt="Logo" />
        </div>
        ...
        <div className="footer-social-icon">
          <ul>
            <li>
              <a
                href="https://github.com/Kishore-MK"
            ...
            <li>
              <a
                href="https://instagram.com/kixxo.io"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Ayitskixxo"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="http://www.linkedin.com/in/kishore-murugesan"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer-content-container">
        <p className="footer-content">Made by MK</p>
        <div className="footer-social--icon">
          <ul>
            <li>
              <Link
